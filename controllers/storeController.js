...
//async and await allows promises
//promise, I will come back to you with data, or an error
//composition, wrap the function to find error
...
exports.getStores = async (req, res) => {
  ...
  if (!stores.length && skip) {
    req.flash('info', `Hey! You asked for page ${page}. It doesn't exist.
  ...
  const query = {
    location: {
      $near: {
        ...
        $maxDistance: 10000 // equal to 10km
      }
    }
  }
